...
var category = {OBJ: $("#_JD_ALLSORT"),
		//URL_Serv: "http://manage.qingke.com/web/itemcat/all?callback=category.getDataService",
		URL_Serv: "http://127.0.0.1:8081/item/all?callback=category.getDataService",
        ...
        return "" == c ? d : (/^http[s]?:\/\/([\w-]+\.)+[\w-]+([\w-.\/?%&=]*)?$/.test(c) || (c = c.replace(/-000$/, ""), c = c.match(/^\d*-\d*$/) ? "http://channel.jd.com/" + c + ".html" : "http://www.qingke.com" + c + ".html"), '<a href="' + c + '">' + d + "</a>")
